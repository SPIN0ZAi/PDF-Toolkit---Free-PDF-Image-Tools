      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
          ...
          <p className="text-yellow-700 dark:text-yellow-300 mb-4">
            PDF decryption is not supported in browser environments due to security limitations.
          </p>
          ...
          <ul className="text-sm text-yellow-600 dark:text-yellow-400 ml-4 mt-2 space-y-1 list-disc">
            ...
            <li>Use command-line tools like <code className="bg-yellow-200 dark:bg-yellow-800 px-1 rounded">qpdf --decrypt</code></li>
            <li>Use online services that support server-side decryption</li>
          </ul>
        </div>
      </div>
    </ToolLayout>
